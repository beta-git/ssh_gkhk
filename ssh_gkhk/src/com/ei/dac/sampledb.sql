...
create table Comment (id bigint not null, multiMediaID bigint, date date, fromUser bigint, content varchar(255), toUser bigint, primary key (id));
create table MultiMedia (id bigint not null, userResourcesID bigint not null, subType varchar(255), date date, primary key (id));
